...
const Skills = ({ id, currentSection, scrollToSection }) => (
  <section
    id={id}
    className="absolute inset-0 flex flex-col items-center justify-center gap-10 p-10 transition-opacity duration-1000"
    style={{
  ...
  >
    <div className="flex items-center justify-center gap-4 mb-10">
      ...
      <h2 className="text-5xl font-bold text-white tracking-wide drop-shadow-lg">
        Yeteneklerim
      </h2>
    </div>
